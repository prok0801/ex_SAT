...
def add_at_most_one_binary(cnf, variables):
...
def add_exactly_one(cnf, variables):
    ...
    add_at_most_one_binary(cnf, variables)
...
def generate_clauses(n):
    ...
    for d in range(2 * n - 1):
        ...
        add_at_most_one_binary(cnf, main_diag_vars)
        add_at_most_one_binary(cnf, anti_diag_vars)
